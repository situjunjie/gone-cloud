...
public interface LogRecordConstants {
    ...
    String DEVOPS_PIPELINE_TYPE = "DEVOPS 流水线";
    ...
    String DEVOPS_PIPELINE_CACHE_CLEAR_SUB_TYPE = "清理流水线缓存";
    ...
    String DEVOPS_PIPELINE_CACHE_CLEAR_SUCCESS = "清理流水线缓存：{{#reqVO.definitionId}}";
